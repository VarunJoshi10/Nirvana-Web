  ...
  <v-container fluid>
    ...
    <div class="my-text">
      <v-col>
        ...
        <v-col cols="100" offset="1">
          
          <v-form v-model="valid" max-width="50">
          
          
            <v-col
            cols="55" sm="100" md="100"
          >
            <v-file-input
            v-model="picture"
            label="Picture"
...
export default {
  ...
  methods: {
    validateForm() {
      const fields = [this.title, this.fullname, this.picture, this.description, this.date, this.time];
